            ...
            if invtz:
                if name == "BEGIN":
                    ...
                    if name == "DTSTART":
                        ...
                        if parms:
                            raise ValueError(
                                "unsupported TZOFFSETTO parm: {}".format(
                                    parms[0])
                            )
                        ...
                        if parms:
                            raise ValueError(
                                "unsupported TZNAME parm: {}".format(parms[0]))
                        tzname = value
                    elif name == "COMMENT":
                        pass
                    else:
                    ...
                    if name == "TZID":
                        if parms:
                            raise ValueError(
                                "unsupported TZID parm: {}".format(parms[0]))
                        tzid = value
